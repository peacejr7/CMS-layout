    ...
    render(){
        return(
            <div className='my-[120px]'>
                ...
                <div className="">
            <div>
            <h2 className="text-yellow-500 text-5xl md:font-bold text-center "> Our Services</h2>
               <p className="text-[#000080] text-2xl mt-6 text-center">We will fully cover the following frameworks and JavaScript programming online</p>
            </div>
